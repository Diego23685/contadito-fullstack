...
namespace Contadito.Api.Migrations
{
    ...
    [Migration("20251004045952_AddExternalLogins")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contadito.Api.Domain.Entities.EmailVerification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("TenantId", "UserId", "Purpose", "Email", "ExpiresAt")
                        .HasDatabaseName("idx_email_verif_user_purpose");

                    b.ToTable("email_verifications", (string)null);
                });

            modelBuilder.Entity("Contadito.Api.Domain.Entities.ExternalLogin", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Contadito.Api.Domain.Entities.InventoryMovement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("TenantId", "ProductId", "MovedAt")
            ...
            modelBuilder.Entity("Contadito.Api.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasIndex("TenantId", "IsPublic", "Name");
            ...
            modelBuilder.Entity("Contadito.Api.Domain.Entities.ReportDefinition", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "Name")
                        .HasDatabaseName("idx_report_tenant_name");
            ...
            modelBuilder.Entity("Contadito.Api.Domain.Entities.SalesItem", b =>
                {
                    ...
                    b.Property<decimal?>("LineMargin")
                        .HasColumnType("decimal(65,30)")
                        .HasColumnName("line_margin");

                    b.Property<decimal?>("LineMarginPct")
                        .HasColumnType("decimal(65,30)")
                        .HasColumnName("line_margin_pct");
            ...
            modelBuilder.Entity("Contadito.Api.Domain.Entities.StoreOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("Number")
                        .IsUnique()
                        .HasDatabaseName("uq_so_number");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("idx_so_tenant");

                    b.ToTable("store_orders", (string)null);
                });

            modelBuilder.Entity("Contadito.Api.Domain.Entities.StoreOrderItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("OrderId")
                        .HasDatabaseName("idx_soi_order");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("idx_soi_tenant");
